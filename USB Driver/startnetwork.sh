...
#NICE="/usr/bin/nice"
WHO="/usr/bin/who"
PUI=`pidof startnetwork`

echo "111">>/tmp/1111.txt
#the GUI progranm to launch by this script
GUI2LAUNCH="/usr/bin/startnetwork http://mobile.hotspot"
